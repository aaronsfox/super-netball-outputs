---
title: "Plus/Minus Data for Super Netball 2021 Team Line-Ups"
author: "Aaron Fox"
date: "18/05/2021"
...
# Suncorp Super Netball 2021: Plus/Minus Analysis
...
#Read in data
data <- read.csv("data/season2021/teamLineUps_plusMinus.csv", stringsAsFactors = FALSE)
...
div(class = "lineUp-plusMinus",
  div(class = "title",
    h2("Suncorp Super Netball 2021: Line-Up +/- Peformance"),
    "Score differentials across different line-ups used by teams in Suncorp Super Netball 2021. Data are presented as absolute score differential (abs.), as well as score differential per 15 minutes player (per.). Line-ups must have played a minimum of 15 minutes together to be included. Team (e.g. 'Vixens') or player (e.g. 'Moloney') names (including a combination of these) can be looked up using the search bars."
  ),
...
#Read in data
dataPlayer <- read.csv("data/season2021/individualPlayer_plusMinus.csv", stringsAsFactors = FALSE)
...
div(class = "lineUp-plusMinus",
  div(class = "title",
    h2("Suncorp Super Netball 2021: Player +/- Peformance"),
    "Score differentials when different players are on vs. off the court in SuncorpSuper Netball 2021. Data are presented as absolute score differential (abs.), as well as score differential per 15 minutes player (per.). The relative differential (diff.) for when the player is on vs. off the court are also presented. Players must have played a minimum of 15 minutes and spent a minimum of 15 minutes off the court to be included. Player (e.g. 'Moloney') names can be looked up using the search bar."
  ),
