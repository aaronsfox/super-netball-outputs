---
title: "Player Stats Data for Super Netball 2020"
author: "Aaron Fox"
date: "07/09/2020"
...
# Suncorp Super Netball 2020: Player Metrics
...
The following tables provide summary metrics for players from Suncorp Super Netball 2020. Metrics are split into loose *attacking* and *defensive* categories.
...
#Read in data
dataAttacking <- read.csv("data/individualPlayerStats_Attacking.csv", stringsAsFactors = FALSE)
...
div(class = "playerStats",
  div(class = "title",
    h2("Suncorp Super Netball 2020: Player Metrics (Attacking)"),
    "Player metrics for attacking categories in Suncorp Super Netball 2020. Within each table, both absolute totals and per 15 minute totals (i.e. metric total relative to 15 minutes played) are presented. Players must have been on-court a minimum of 15 minutes to be included. Team (e.g. 'Vixens') or player (e.g. 'Watson') names can be looked up using the search bars."
  ),
  attackingStats_tbl
)
...
#Read in data
dataDefensive <- read.csv("data/individualPlayerStats_Defensive.csv", stringsAsFactors = FALSE)
...
div(class = "playerStats",
  div(class = "title",
    h2("Suncorp Super Netball 2020: Player Metrics (Defensive)"),
    "Player metrics for defensive categories in Suncorp Super Netball 2020. Within each table, both absolute totals and per 15 minute totals (i.e. metric total relative to 15 minutes played) are presented. Players must have been on-court a minimum of 15 minutes to be included. Team (e.g. 'Vixens') or player (e.g. 'Watson') names can be looked up using the search bars."
  ),
  defensiveStats_tbl
)
